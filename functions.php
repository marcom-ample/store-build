...
function twentytwelve_setup() {
	...
	register_nav_menu( 'footer-one', __( 'Footer Menu One', 'twentytwelve' ) );
	register_nav_menu( 'footer-two', __( 'Footer Menu Two', 'twentytwelve' ) );
	register_nav_menu( 'footer-three', __( 'Footer Menu Three', 'twentytwelve' ) );
...
/**
 * Login/Logout custom menu
 */

add_filter( 'wp_nav_menu_items', 'add_loginout_link', 10, 2 );
function add_loginout_link( $items, $args ) {
    if (is_user_logged_in() && $args->theme_location == 'primary') {
        $items .= '<li class="logout"><a href="'. wp_logout_url(home_url()) .'">LogOut</a></li>';
    }
    return $items;
}
   	//Login Screen
